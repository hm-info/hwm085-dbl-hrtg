...
**ResistanceNo:** If the Resistance No column value is **0**, it works in standard welding position. If **1**, it is used for **SASH** profile welding operations. If **2**, it is used for **CASEMENT** profile welding operations.
